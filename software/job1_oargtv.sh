...
infile="/m/cs/scratch/faceai/rawdata/OAR_GTV/"$SLURM_ARRAY_TASK_ID"/"$SLURM_ARRAY_TASK_ID"_T2.nii.gz"
outfolder="/m/cs/scratch/faceai/projects/faceai_testingdefacing/results/OAR_GTV/"
if [ -f $infile ]; then
