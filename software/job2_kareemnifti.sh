...
infile="/m/cs/scratch/faceai/projects/faceai_testingdefacing/data/kareem/nifti_reduced/"$SLURM_ARRAY_TASK_ID"/"$SLURM_ARRAY_TASK_ID"_T2.nii.gz"
outfolder="/m/cs/scratch/faceai/projects/faceai_testingdefacing/results/kareem_niftireduced/"
if [ -f $infile ]; then
